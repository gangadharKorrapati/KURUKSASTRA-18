...
<body>
    ...
    <div class="nav-wrapper container">
      ...
      <ul class="left hide-on-med-and-down">
        ...
        <ul class="right hide-on-med-and-down">
            <li><a class="btn transparent" href="login.php">Login</a></li>
            <li><a class="btn transparent" href="signup.php">SignUp</a></li>
        </ul>
    ...
    <br>
        <div class="row center">
            ...
            <img class="" src="img/ksnavwhite.svg" style="height:60%px;width:65%;margin-top:2%">
            <br>
            <h4 class="white-text">2018 March 23rd 24th 25th</h4>
            <br>
            <a class="btn transparent" href="login.php">Login</a>&nbsp;&nbsp;
            <a class="btn transparent" href="signup.php">Signup</a>&nbsp;&nbsp;
            <a class="btn transparent" href="login.php">Campus Ambassodor</a>&nbsp;&nbsp;
            </div>
        </div>
    <br>
    <br>
